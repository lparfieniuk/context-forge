...
**Output:**
```
core/rules/020-cf-api-boundary.yaml  — metadata (mode: intelligent, alwaysApply: false)
core/rules/020-cf-api-boundary.md    — content (SYSTEM CONSTRAINTS + example + gate)
```
