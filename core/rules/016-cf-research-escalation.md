...
Authority order: **official docs / source > GitHub issue > forum / Reddit**. Reddit is a strong lead source for version quirks and gotchas but is NEVER the final authority — same lead-not-truth discipline as any curated local source (e.g. a local knowledge base; see 815-cf-mcp-private if present on this machine).
